 ...
 */
class NewsCategoryBase extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('news_category_topic', 'length', 'max'=>255),
			array('datecreate', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('news_category_id, news_category_topic, status, datecreate', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'news_category_topic' => 'News Category Topic',
			'status' => 'Status',
	...
	public function search()
	{
		...
		$criteria->compare('news_category_topic',$this->news_category_topic,true);
	 ...
	 * @return NewsCategoryBase the static model class
	 */
